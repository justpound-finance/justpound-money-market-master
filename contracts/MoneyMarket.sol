...
/**
  * @title The Justpound MoneyMarket Contract
  * @author Justpound
  * @notice The Justpound MoneyMarket Contract in the core contract governing
  *         all accounts in Justpound.
  */
contract MoneyMarket is Exponential, SafeToken {
    ...
    /**
      * @notice `MoneyMarket` is the core Justpound MoneyMarket contract
      */
    constructor() public {
        admin = msg.sender;
    ...
    /**
      * @notice Supports a given market (asset) for use with Justpound
    ...
    /**
      * @notice Suspends a given *supported* market (asset) from use with Justpound.
    ...
    function liquidateBorrow(address targetAccount, address assetBorrow, address assetCollateral, uint requestedAmountClose) public returns (uint) {
        ...
        // We are going to ERC-20 transfer closeBorrowAmount_TargetUnderwaterAsset of assetBorrow into Justpound
        // Fail gracefully if asset is not approved or has insufficient balance
